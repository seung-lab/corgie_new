...
@corgie_option("--start_coord", nargs=1, type=str, help="Comma delimited triple specified in destination voxels by --coord_mip. e.g. 1000,200,55", required=True)
@corgie_option("--end_coord", nargs=1, type=str, help="Comma delimited triple specified in destination voxels by --coord_mip. e.g. 2000,500,70", required=True)
